...
export JAVAC_EXTRACTOR_JAR="/opt/kythe/kythe-v0.0.53/extractors/javac_extractor.jar"
export KYTHE_CORPUS="K2"
export KYTHE_VNAMES="/opt/kythe/kythe-v0.0.53/vnames.java.json"
export KYTHE_ROOT_DIRECTORY="/home/hdd1/k2"
export KYTHE_OUTPUT_DIRECTORY="/home/hdd1/out/extracts"
...
if [[ -z "$REAL_JAVAC" ]]; then
  ...
  readonly REAL_JAVAC="/home/hdd1/k2/prebuilts/jdk/jdk11/linux-x86/bin/javac.real"
fi
if [[ -z "$JAVAC_EXTRACTOR_JAR" ]]; then
  readonly JAVAC_EXTRACTOR_JAR="/opt/kythe/kythe-v0.0.53/extractors/javac_extractor.jar"
fi
...
echo "$JAVABIN" "${KYTHE_JAVA_RUNTIME_OPTIONS[@]}" \
